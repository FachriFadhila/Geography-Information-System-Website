...
var sekolah_sd = new L.LayerGroup();
...
'Sekolah SD Terdekat' :sekolah_sd
}
};
...
div.innerHTML = '<img src="<?=base_url()?>assets/images/arah-mata-angin.png"style=width:200px;>';
return div; }
north.addTo(map);
...
$.getJSON("<?=base_url()?>assets/sekolah_sd.geojson",function(data){
var ratIcon = L.icon({
